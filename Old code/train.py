...
def parse_opt(): 
    ...
    parser.add_argument('--full-training-dir', type=str, default='scripts/database/full-training-datasets/', help='dir folder full training')
    parser.add_argument('--additional-training-dir', type=str, default='scripts/database/additional-training-datasets/', help='dir folder additional training')
    parser.add_argument('--faces-save-dir', type=str, default='scripts/database/face-datasets/', help='dir folder save face features')
    parser.add_argument('--features-save-dir', type=str, default='scripts/static/feature/face_features', help='dir folder save face features')
